	...
	public static boolean connect() {
		...
		try {
			...
			config.setJdbcUrl(String.format(
					"jdbc:mysql://%s:%s/%s?useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC",
					properties.getProperty("database.host"), properties.getProperty("database.port"),
