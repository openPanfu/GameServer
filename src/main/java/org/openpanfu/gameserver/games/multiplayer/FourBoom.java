...
public class FourBoom {
    ...
    public void onEnter(User user)
    {
        ...
        if(queue.hasUserWaiting()) {
            ...
            Logger.info(String.format("[4boom] Player %s was matched with %s from the 4boom queue!", user.getUsername(), victim.getUsername()));
    ...
    // Called on CMD_MULTIGAME, used to inform the other user of a multiplayer interaction
