...
public interface IPlugin {
     ...
     * @return Boolean Returning true will allow the plugin to use the other methods.
     */
    boolean onStartup();
     ...
     * @param roomId The roomId of the room they just joined.
     * If the user just entered a home,
     * this will be the user id of the person who's home they just joined.
     * @param isHome Whether that room is a user home.
     */
    void onUserJoinRoom(User user, int roomId, boolean isHome);

    /**
     * Called when a user *tries* to enter a room, this allows you to override normal room joining behavior.
     * @param user The user that just joined the room.
     * @param roomId The roomId of the room they just joined.
     * If the user just entered a home,
     * this will be the user id of the person who's home they just joined.
     ...
     * @param user The user that just connected.
     * @return boolean If false, the user's session will be denied and they will be disconnected.
     */
